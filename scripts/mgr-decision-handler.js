...
/**
 * 决策处理器 v1.0
 * 指令示例: node scripts/mgr-decision-handler.js --stage=TR3 --result=Go --expert="Arch-Team"
 */

// Role Gate Check
try {
    execSync('node scripts/mgr-role-gate.js --action=DECISION_PASS', { stdio: 'inherit' });
} catch (e) {
    process.exit(1);
}
