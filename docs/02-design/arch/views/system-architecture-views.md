...
## 2. 核心架构资产映射
- **L0 资产**: `docs/02-design/arch/views/system-architecture-views.md`
- **L1 资产**: `docs/02-design/arch/views/microservice-decomposition-l1.md`
- **L2 资产**: `docs/02-design/arch/views/component-decomposition-l2.md`
